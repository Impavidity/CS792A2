...
class thrift_dir_entry : public virtual ::apache::thrift::TBase {
 public:
...
class thrift_readdir_reply : public virtual ::apache::thrift::TBase {
 public:
...
class thrift_file_info : public virtual ::apache::thrift::TBase {
 public:
...
class thrift_timespec : public virtual ::apache::thrift::TBase {
 public:
...
class thrift_stat : public virtual ::apache::thrift::TBase {
 public:
...
class thrift_getattr_reply : public virtual ::apache::thrift::TBase {
 public:
...
class thrift_file_handler : public virtual ::apache::thrift::TBase {
 public:
